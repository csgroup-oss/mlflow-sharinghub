...
waitForElm('header').then((header) => {{
    ...
    if (!isIframe()) {{
        ...
        openLink.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="2em" height="20px" fill="none" viewBox="0 0 16 16" aria-hidden="true" focusable="false" class=""><path fill="currentColor" d="M10 1h5v5h-1.5V3.56L8.53 8.53 7.47 7.47l4.97-4.97H10V1Z"></path><path fill="currentColor" d="M1 2.75A.75.75 0 0 1 1.75 2H8v1.5H2.5v10h10V8H14v6.25a.75.75 0 0 1-.75.75H1.75a.75.75 0 0 1-.75-.75V2.75Z"></path></svg>`;
        openLink.style = labelStyle;
        headerRightLinks.appendChild(openLink);
    }}
}});
"""  # noqa: E501
